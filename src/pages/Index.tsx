        ...
        <section className="py-16 text-center">
          <Card className="bg-gradient-to-r from-primary/10 to-secondary/20 border-primary/20">
            <CardHeader>
              ...
              <CardTitle className="text-2xl">{t("downloadApp") || "Get the Casher App"}</CardTitle>
              <CardDescription className="text-base">
                {t("downloadAppDesc") || "Take control of your finances on the go. Download our mobile app for iOS or Android."}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  {t("downloadIOS") || "Download for iOS"}
                </Button>
                <Button 
                  size="lg" 
                  variant="outline"
              ...
              <p className="text-xs text-muted-foreground mt-4">
                {t("comingSoon") || "Coming soon to App Store and Google Play"}
              </p>
            </CardContent>
          </Card>
        </section>
