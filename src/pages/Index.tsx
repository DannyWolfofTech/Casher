      ...
      <nav className="w-full border-b border-foreground/10">
        <div className="max-w-7xl mx-auto py-4 px-4 md:px-8 flex flex-wrap gap-3 items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden md:flex gap-7 text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">
      ...
      <section className="w-full">
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-20 md:py-28">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12 gap-6">
            ...
            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground font-bold">Three quiet steps</p>
          </div>
