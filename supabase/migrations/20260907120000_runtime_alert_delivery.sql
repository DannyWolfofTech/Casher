-- Runtime mail must omit run_id so Lovable creates the transactional run.
-- A randomly invented build run is rejected by the provider.
...
BEGIN
  ...
  PERFORM public.enqueue_email('transactional_emails',jsonb_build_object(
    'message_id',message_id,'idempotency_key','casher-operations-'||message_id,
